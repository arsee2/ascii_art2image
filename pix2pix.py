...
parser.add_argument("--input_dir", default="C:\\Users\\arsee\Desktop\\all-in-one\\contours\\concatenated\\",help="path to folder containing images")
parser.add_argument("--mode", default='train', choices=["train", "test", "export"])
parser.add_argument("--output_dir", default='ascii2edges\\', help="where to put output files")
...
parser.add_argument("--ngf", type=int, default=128, help="number of generator filters in first conv layer")
